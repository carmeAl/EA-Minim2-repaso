...
abstract class Constants {
  ...
  static Ticket ticket = Ticket(
      ...
      isEnabled: true,
      completado: []);
  static GrupoPopulate grupoPopulate = GrupoPopulate(
      id: "",
      name: "",
      codigo: "codigo",
      users: <User>[],
  ...
  static Ticket ticketPopulate = Ticket(
      id: "",
      nombre: "",
      productos: <Producto>[],
      ...
      isEnabled: true,
      completado: []);
  static Producto productoPopulate = Producto(
      id: "",
      name: "",
      quantity: 0,
      totalprice: 0,
